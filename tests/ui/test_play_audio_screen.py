...
class TestPlayAudioScreen(unittest.TestCase):
    ...
    def test_initial_values(self):
        ...
        self.assertIsNone(self.play_audio_screen.audio_player)
    ...
    #     self.play_audio_screen.audio_player = MagicMock()
    #     self.play_audio_screen.audio_player.get_position.return_value = 10
    #     self.play_audio_screen.time_stamp = TimeStampManager(MagicMock())
    #     self.play_audio_screen.set_time_stamp()
    #     self.assertIn(10, self.play_audio_screen.time_stamp.time_stamp_list)
    #     self.assertEqual(self.play_audio_screen.time_stamp.time_stamp_index, 1)
